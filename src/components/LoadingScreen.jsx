        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center mt-8 lg:mt-0 mb-16 lg:mb-0">
          ...
          <div className="flex flex-col space-y-8 relative">
            <div className="space-y-4 text-center lg:text-left">
              ...
              <div className="max-w-md bg-white/5 border border-white/10 rounded-2xl px-5 py-4 text-sm text-gray-400 leading-relaxed space-y-1">
                <p className="text-white/70 font-semibold text-xs uppercase tracking-widest mb-2">Server availability</p>
                <p>
                  The server normally stays warm between{' '}
                  <span className="text-green-400 font-medium">9:00 AM – 10:00 PM IST</span>.
                  Visiting during that window gives you instant access.
                </p>
                <p className="text-gray-500">
                  Outside those hours, the server may be asleep — just wait here for 3–5 minutes and it will wake up automatically.
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col items-center justify-between space-y-6">
            ...
            {/* Status Message */}
            <div className="flex items-center justify-center text-sm font-medium pt-2">
              {isBackendError ? (
